...
This demo registers a full `ppt-polished-deck-collab` workspace under `demos/` and showcases the current positioning of the skill: deck-level planning, editable PPT generation, preview export, and validation evidence for a polished PowerPoint deliverable.
...
python ppt-polished-deck-collab/scripts/derive_slide_specs_from_narrative.py \
  --narrative demos/standard-wars-executive-deck/deck_narrative.md \
  --out-yaml demos/standard-wars-executive-deck/build/generated/slide_specs.yaml
```
