...
STYLE_ID_TO_ROLE = {
    ...
    "BcgDocTitle": "doc_title",
    "BcgSubtitle": "subtitle",
    "BcgHeading1": "heading_1",
    "BcgHeading2": "heading_2",
    "BcgHeading3": "heading_3",
    "BcgHeading4": "heading_4",
    "BcgLead": "lead",
    "BcgBody": "body",
    "BcgList": "list",
    "BcgTableTitle": "table_title",
    "BcgTableCaption": "table_caption",
    "BcgFigureTitle": "figure_title",
    "BcgFigureNote": "figure_note",
    "BcgSourceNote": "source_note",
    "BcgFigureBody": "figure_body",
    "BainDocTitle": "doc_title",
    "BainSubtitle": "subtitle",
    "BainHeading1": "heading_1",
    "BainHeading2": "heading_2",
    "BainHeading3": "heading_3",
    "BainHeading4": "heading_4",
    "BainLead": "lead",
    "BainBody": "body",
    "BainList": "list",
    "BainTableTitle": "table_title",
    "BainTableCaption": "table_caption",
    "BainFigureTitle": "figure_title",
    "BainFigureNote": "figure_note",
    "BainSourceNote": "source_note",
    "BainFigureBody": "figure_body",
    "McKDocTitle": "doc_title",
    "McKSubtitle": "subtitle",
    "McKHeading1": "heading_1",
    "McKHeading2": "heading_2",
    "McKHeading3": "heading_3",
    "McKHeading4": "heading_4",
    "McKLead": "lead",
    "McKBody": "body",
    "McKList": "list",
    "McKTableTitle": "table_title",
    "McKTableCaption": "table_caption",
    "McKFigureTitle": "figure_title",
    "McKFigureNote": "figure_note",
    "McKSourceNote": "source_note",
    "McKFigureBody": "figure_body",
}
...
def build_style_registry() -> dict[str, StyleProfile]:
    ...
    bcg_dark_teal_report = StyleProfile(
        name="bcg_dark_teal_report",
        font_profile=FontProfile(chinese="微软雅黑", latin="Arial"),
        role_specs={
            "doc_title": ParagraphSpec("BcgDocTitle", 26.0, True, "left", 1.0, 0.0, 12.0, 0.0, "#16845F", "Arial", "微软雅黑", True),
            "subtitle": ParagraphSpec("BcgSubtitle", 11.0, False, "left", 1.1, 0.0, 10.0, 0.0, "#4D5559", "Arial", "微软雅黑", True),
            "heading_1": ParagraphSpec("BcgHeading1", 28.0, True, "left", 1.05, 10.0, 14.0, 0.0, "#16845F", "Arial", "微软雅黑", True),
            "heading_2": ParagraphSpec("BcgHeading2", 14.0, True, "left", 1.05, 10.0, 5.0, 0.0, "#30383D", "Arial", "微软雅黑", True),
            "heading_3": ParagraphSpec("BcgHeading3", 10.0, True, "left", 1.05, 6.0, 2.0, 0.0, "#30383D", "Arial", "微软雅黑", True),
            "heading_4": ParagraphSpec("BcgHeading4", 9.2, True, "left", 1.05, 5.0, 2.0, 0.0, "#30383D", "Arial", "微软雅黑", True),
            "lead": ParagraphSpec("BcgLead", 10.0, False, "left", 1.12, 0.0, 8.0, 0.0, "#4D5559", "Arial", "微软雅黑"),
            "body": ParagraphSpec("BcgBody", 9.2, False, "left", 1.08, 0.0, 6.0, 0.0, "#5F666A", "Arial", "微软雅黑"),
            "list": ParagraphSpec("BcgList", 9.2, False, "left", 1.08, 0.0, 5.0, 0.0, "#5F666A", "Arial", "微软雅黑"),
            "table_title": ParagraphSpec("BcgTableTitle", 10.0, True, "left", 1.0, 8.0, 3.0, 0.0, "#30383D", "Arial", "微软雅黑", True),
            "table_caption": ParagraphSpec("BcgTableCaption", 7.0, False, "left", 1.0, 0.0, 6.0, 0.0, "#6F777B", "Arial", "微软雅黑"),
            "figure_title": ParagraphSpec("BcgFigureTitle", 11.0, True, "left", 1.0, 8.0, 2.0, 0.0, "#30383D", "Arial", "微软雅黑", True),
            "figure_note": ParagraphSpec("BcgFigureNote", 7.0, False, "left", 1.0, 0.0, 2.0, 0.0, "#6F777B", "Arial", "微软雅黑"),
            "source_note": ParagraphSpec("BcgSourceNote", 7.0, False, "left", 1.0, 0.0, 6.0, 0.0, "#6F777B", "Arial", "微软雅黑"),
            "figure_body": ParagraphSpec("BcgFigureBody", 9.2, False, "center", 1.0, 0.0, 0.0),
        },
    ...
    bain_red_pe_report = StyleProfile(
        name="bain_red_pe_report",
        font_profile=FontProfile(chinese="宋体", latin="Times New Roman"),
        role_specs={
            "doc_title": ParagraphSpec("BainDocTitle", 18.0, True, "left", 1.0, 0.0, 10.0, 0.0, "#111111", "Arial", "微软雅黑"),
            "subtitle": ParagraphSpec("BainSubtitle", 9.5, False, "left", 1.1, 0.0, 8.0, 0.0, "#555555", "Arial", "微软雅黑"),
            "heading_1": ParagraphSpec("BainHeading1", 16.0, True, "left", 1.05, 12.0, 7.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "heading_2": ParagraphSpec("BainHeading2", 12.0, True, "left", 1.05, 10.0, 5.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "heading_3": ParagraphSpec("BainHeading3", 10.0, True, "left", 1.05, 6.0, 3.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "heading_4": ParagraphSpec("BainHeading4", 9.5, True, "left", 1.05, 5.0, 2.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "lead": ParagraphSpec("BainLead", 10.5, True, "left", 1.10, 0.0, 8.0, 0.0, "#222222", "Arial", "微软雅黑"),
            "body": ParagraphSpec("BainBody", 10.0, False, "left", 1.08, 0.0, 7.0),
            "list": ParagraphSpec("BainList", 9.5, False, "left", 1.08, 0.0, 6.0),
            "table_title": ParagraphSpec("BainTableTitle", 10.0, True, "left", 1.0, 10.0, 4.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "table_caption": ParagraphSpec("BainTableCaption", 6.5, False, "left", 1.0, 0.0, 6.0, 0.0, "#555555", "Arial", "微软雅黑"),
            "figure_title": ParagraphSpec("BainFigureTitle", 10.0, True, "left", 1.0, 10.0, 4.0, 0.0, "#111111", "Arial", "微软雅黑", True),
            "figure_note": ParagraphSpec("BainFigureNote", 6.5, False, "left", 1.0, 0.0, 2.0, 0.0, "#555555", "Arial", "微软雅黑"),
            "source_note": ParagraphSpec("BainSourceNote", 6.5, False, "left", 1.0, 0.0, 6.0, 0.0, "#555555", "Arial", "微软雅黑"),
            "figure_body": ParagraphSpec("BainFigureBody", 10.0, False, "center", 1.0, 0.0, 0.0),
        },
        table_font_size_pt=9.0,
        dense_table_font_size_pt=8.5,
        table_title_position="above",
    ...
    mckinsey_blue_article = StyleProfile(
        name="mckinsey_blue_article",
        font_profile=FontProfile(chinese="宋体", latin="Arial"),
        role_specs={
            "doc_title": ParagraphSpec("McKDocTitle", 25.0, True, "left", 0.95, 0.0, 12.0, 0.0, "#071828", "Georgia", "宋体", True),
            "subtitle": ParagraphSpec("McKSubtitle", 9.5, False, "left", 1.1, 0.0, 10.0, 0.0, "#5C6470", "Arial", "微软雅黑", True),
            "heading_1": ParagraphSpec("McKHeading1", 15.5, True, "left", 1.02, 14.0, 7.0, 0.0, "#071828", "Georgia", "宋体", True),
            "heading_2": ParagraphSpec("McKHeading2", 11.8, True, "left", 1.05, 10.0, 5.0, 0.0, "#071828", "Georgia", "宋体", True),
            "heading_3": ParagraphSpec("McKHeading3", 10.0, True, "left", 1.08, 7.0, 3.0, 0.0, "#1E2C3A", "Arial", "微软雅黑", True),
            "heading_4": ParagraphSpec("McKHeading4", 9.6, True, "left", 1.08, 6.0, 3.0, 0.0, "#1E2C3A", "Arial", "微软雅黑", True),
            "lead": ParagraphSpec("McKLead", 11.0, True, "left", 1.28, 0.0, 10.0, 0.0, "#2E3A46", "Arial", "微软雅黑"),
            "body": ParagraphSpec("McKBody", 10.0, False, "left", 1.24, 0.0, 8.0, 0.0, "#333333", "Arial", "微软雅黑"),
            "list": ParagraphSpec("McKList", 9.5, False, "left", 1.18, 0.0, 6.0, 0.0, "#333333", "Arial", "微软雅黑"),
            "table_title": ParagraphSpec("McKTableTitle", 9.5, True, "left", 1.0, 10.0, 3.0, 0.0, "#071828", "Arial", "微软雅黑", True),
            "table_caption": ParagraphSpec("McKTableCaption", 6.5, False, "left", 1.0, 0.0, 7.0, 0.0, "#6A6F75", "Arial", "微软雅黑"),
            "figure_title": ParagraphSpec("McKFigureTitle", 11.0, True, "left", 1.05, 12.0, 5.0, 0.0, "#071828", "Georgia", "宋体", True),
            "figure_note": ParagraphSpec("McKFigureNote", 6.5, False, "left", 1.0, 0.0, 2.0, 0.0, "#6A6F75", "Arial", "微软雅黑"),
            "source_note": ParagraphSpec("McKSourceNote", 6.5, False, "left", 1.0, 0.0, 8.0, 0.0, "#6A6F75", "Arial", "微软雅黑"),
            "figure_body": ParagraphSpec("McKFigureBody", 10.0, False, "center", 1.0, 0.0, 0.0),
        },
    ...
    return {
        ...
        bcg_dark_teal_report.name: bcg_dark_teal_report,
        bain_red_pe_report.name: bain_red_pe_report,
        mckinsey_blue_article.name: mckinsey_blue_article,
    }
