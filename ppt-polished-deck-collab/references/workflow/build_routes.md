...
**这份文档的定位。** 本文统一说明环境依赖、可用构建路线、预览导出 backend、diagram 路线和它们的选择标准。它是 `references/modules/technical_support.md` 之下的细化实现文档，替代原来分散的 requirements 与 technical routes 文档。
